...
public class JustEat_Scenario_FindRestaurantByPostalCode {
	
	@Test
	public static void JustEat_FindRestaurantByPostalCode() throws Exception{
	...
	private static void AddFoodToBasket(WebDriver driver) throws Exception {
		...
		driver.findElement(By.xpath("//*[contains(@class,'removeBasketItemButton')]")).click();
